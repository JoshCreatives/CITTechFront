...
const Hero = () => {
  ...
  return (
    <>
              ...
              <div className="text-center text-white px-4 max-w-4xl">
                ...
                >
                  <button
                    ...
                    className="bg-red-700 text-white px-6 py-2 md:px-8 md:py-3 rounded-full text-lg font-semibold hover:bg-red-900 transition-colors inline-block cursor-pointer"
                  >
                    Get started
                  </button>
                </motion.div>
      ...
      {/* This is the reference point for the next section */}
      <div ref={nextSectionRef} className="h-0 w-0" aria-hidden="true" />
    </>
  );
};
