...
const Alumni = () => {
  ...
  const alumni = [
    {
      image:
        "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1744&q=80",
      name: "James Rodriguez",
      batch: "2018",
      role: "Senior Software Engineer",
      company: "Google",
      quote:
        "SIIT provided me with the foundation I needed to succeed in tech.",
    },
    {
      image:
      ...
      company: "Microsoft",
      quote:
        "The practical experience at SIIT was invaluable for my career growth.",
    },
    {
      image:
        "https://images.unsplash.com/photo-1556157382-97eda2d62296?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
      name: "David Chen",
      batch: "2020",
      role: "Data Scientist",
      company: "Amazon",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our graduates are making waves across industries, leading innovation
            and driving change in top companies worldwide.
          </p>
        </div>
