...
const AlumniStories = () => {
  ...
  const filteredAlumni = featuredAlumni.filter(
    (a) =>
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            <div className="max-w-3xl">
              <h1 className="text-5xl font-bold text-white mb-6">
                BSIT Alumni Success Stories
              </h1>
              <p className="text-xl text-gray-200 mb-8">
                Discover how our Bachelor of Science in Information Technology
                graduates are excelling in the tech industry worldwide.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        >
          <h2 className="text-3xl font-bold mb-4 text-white">
            Share Your IT Journey
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto">
            Are you a BSIT graduate? Share your career progression and inspire
            current students by showcasing the diverse opportunities in the IT
            field.
          </p>
          <motion.button
