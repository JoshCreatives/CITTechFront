...
export default function ClassSchedules() {
            ...
            ${filteredSchedules
              ...
              <div class="schedule-card">
                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 15px;">
                  <div>
                    <div class="course-title">${schedule.course_code} - ${
                ...
                <div class="info-grid">
                  ...
                  <div class="course-info">📅 Days: ${schedule.days.join(
                    ", "
                  )}</div>
                  <div class="course-info">📍 Location: ${
                    schedule.building
                  } - Room ${schedule.room}</div>
                  <div class="course-info">👥 Students: ${schedule.enrolled}/${
                  schedule.capacity
                }</div>
                  <div class="course-info">📚 Credits: ${schedule.credits}</div>
                  <div class="course-info">🏫 Department: ${
                    schedule.department
                  }</div>
                </div>
              </div>
  ...
  const sendVerificationCode = async () => {
    try {
      ...
      setSuccessMessage(
        "Verification code sent successfully! Check your email for the 6-digit code."
      );
                ...
                {verificationSent && !isEmailVerified && (
                  ...
                  >
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Check your email inbox (and spam folder) for the 6-digit
                      verification code.
                    </p>
                  </motion.div>
                )}
            ...
            {filteredSchedules.length > 0 ? (
              ...
              >
                <p className="text-gray-500 dark:text-gray-400">
                  No classes found for your batch.
                </p>
              </motion.div>
            )}
          </motion.div>
