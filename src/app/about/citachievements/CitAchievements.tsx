...
const achievements: Achievement[] = [
  {
    ...
    year: "2024",
    description:
      "Ranked among the top 10 information technology colleges in the nation by TechEd Rankings for academic excellence and industry partnerships.",
    details: [
    ...
    impact:
      "Enhanced reputation attracting top-tier students and faculty nationwide",
    image: "/top2.jpg",
    ranking: "#8",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Designated as a National Center of Academic Excellence in Cyber Defense Education by the NSA and DHS.",
    details: [
    ...
    impact:
      "Students eligible for federal cybersecurity scholarships and priority hiring",
    image: "/wangs.jpg",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Received largest research grant in college history for AI and machine learning research from the National Science Foundation.",
    details: [
  ...
  },
  {
    ...
    year: "2024",
    description:
      "CIT programming team won first place at the International Collegiate Programming Contest (ICPC) World Finals.",
    details: [
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Recognized for outstanding collaboration with technology industry partners in curriculum development and student placement.",
    details: [
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Three faculty members received prestigious research awards for contributions to their respective fields.",
    details: [
    ...
    impact:
      "Enhanced research reputation and attracted top-tier graduate students",
    image: "/top4.jpg",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Awarded for developing sustainable technology solutions that reduce campus energy consumption by 30%.",
    details: [
    ...
    impact:
      "Model for other institutions seeking sustainable technology solutions",
    image: "/top5.jpg",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Recognized for outstanding international student exchange programs and global partnerships.",
    details: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            Celebrating our remarkable accomplishments in academics, research,
            industry partnerships, and student success that establish CIT as a
            ...
            return (
              <motion.div
                ...
                className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700 ${
                  index === 0
                    ? "ring-2 ring-maroon-600 dark:ring-maroon-500"
                    : ""
                }`}
              >
                {index === 0 && (
        ...
        >
          ...
          <p className="text-maroon-100 mb-6 max-w-2xl mx-auto">
            Join a college that's making history in technology education.
            Experience excellence, innovation, and achievement at every level of
