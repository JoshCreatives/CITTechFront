    ...
    try {
      ...
      if (!blogImagesBucket) {
        ...
        const { error: createError } =
          await supabaseClient.storage.createBucket("blog-images", {
            public: true,
          });
    ...
    try {
      ...
      if (imageFile && bucketInitialized) {
        ...
        try {
          ...
          alert(
            "Failed to delete old image, but post will be updated without image."
          );
          imageUrl = "";
        }
      }
    ...
    <div className="space-y-6">
      {!bucketInitialized && (
        <div className="bg-yellow-900 text-yellow-200 p-4 rounded-lg">
          ...
          <p>
            Please make sure you have created an "blog-images" bucket in your
            Supabase Storage.
          </p>
          <button
