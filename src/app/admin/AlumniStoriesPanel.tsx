...
export default function AlumniStoriesPanel({
  supabaseClient,
  loading,
  setLoading,
}: any) {
  ...
  async function uploadImage(file: File, type: "featured" | "success") {
    try {
      ...
      const {
        data: { publicUrl },
      } = supabaseClient.storage.from("alumni-images").getPublicUrl(filePath);
  ...
  async function saveEdit() {
    if (
      ...
      alert(
        "Please fill in all required fields: Name, Batch, Role, and Company"
      );
      return;
    }
    ...
    try {
      if (editType === "featured") {
        if (isAdding) {
          await supabaseClient.from("featured_alumni").insert({
            name: editData.name,
        ...
        if (isAdding) {
          await supabaseClient.from("success_stories").insert({
            name: editData.name,
            batch: editData.batch,
            role: editData.role,
            company: editData.company,
  ...
  return (
    <div className="space-y-12 p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
      <h1 className="text-3xl font-bold text-maroon-700 dark:text-white mb-8">
        Alumni Stories Management
      </h1>

      {/* Featured Alumni */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-maroon-700 dark:text-white">
            Featured Alumni
          </h2>
          <button
        ...
        {isAdding === "featured" && (
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 mb-6">
            <h3 className="text-lg font-bold mb-4 text-maroon-700 dark:text-white">
              Add New Featured Alumni
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditData((d: any) => ({ ...d, batch: e.target.value }))
                }
              ...
              <input
                ...
                value={editData.role}
                onChange={(e) =>
                  setEditData((d: any) => ({ ...d, role: e.target.value }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setEditData((d: any) => ({ ...d, company: e.target.value }))
                }
                placeholder="Company *"
              />
            </div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setEditData((d: any) => ({ ...d, quote: e.target.value }))
              }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredAlumni.map((item: any) =>
            editId === item.id && editType === "featured" ? (
              ...
              >
                <h4 className="font-bold mb-3 text-maroon-700 dark:text-white">
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditData((d: any) => ({ ...d, location: e.target.value }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setEditData((d: any) => ({ ...d, story_url: e.target.value }))
                }
