...
export default function ClassSchedulesPanel({
  ...
  const [showAddStudentToSchedule, setShowAddStudentToSchedule] =
    useState(false);
  ...
  async function addClassSchedule() {
    ...
    try {
      ...
      const { error } = await supabaseClient.from("class_schedules").insert([
        {
  ...
  async function addStudentToSchedule(
    scheduleId: string,
  ...
  async function removeStudentFromSchedule(
    scheduleId: string,
    studentNumber: string
  ) {
    setLoading(true);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewSchedule({ ...newSchedule, studentId: e.target.value })
                }
                className="w-full px-3 py-2 rounded bg-gray-700 text-white border border-gray-600 focus:border-red-500 focus:ring-1 focus:ring-red-500 outline-none transition"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewSchedule({ ...newSchedule, courseCode: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewSchedule({ ...newSchedule, courseName: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewSchedule({ ...newSchedule, credits: e.target.value })
                }
                placeholder="e.g., 3"
                className="w-full px-3 py-2 rounded bg-gray-700 text-white border border-gray-600 focus:border-red-500 focus:ring-1 focus:ring-red-500 outline-none transition"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewSchedule({ ...newSchedule, yearLevel: e.target.value })
                }
                ...
                <ul className="bg-gray-700 rounded p-2 max-h-32 overflow-y-auto">
                  {schedule.enrolledStudents.map((studentNumber: string) => {
                    const student = students.find(
                      (s: any) => s.student_number === studentNumber
                    );
                    return student ? (
                      <li
                        key={studentNumber}
      ...
      {classSchedules.length === 0 && (
        <div className="text-center py-12 bg-gray-800 rounded-lg border border-gray-700">
          <p className="text-gray-400">
            No class schedules found. Add one to get started!
          </p>
        </div>
      )}
    </div>
