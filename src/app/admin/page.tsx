...
import ClassSchedulesPanel from "./ClassSchedulePanel";
...
export default function AdminPage() {
  ...
  const [panel, setPanel] = useState<
    "blog" | "citlounge" | "citlife" | "alumni" | "schedules"
  >("blog");
  ...
  //   const { error } = await supabaseClient.from("class_schedules")
  //     .select(`
  //       *,
  ...
  //     alert(
  //       "Failed to add student to schedule" +
